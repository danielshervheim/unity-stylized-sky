...
Shader "danielshervheim/STYLIZED/CLOUD"
{
	Properties
	{
		[MaterialTitle(CLOUD)]_Title("Title", Int) = 0
		[Header(Shadow Settings) ]_ShadowMultiplier("Shadow Multiplier", Float) = 1
		_ShadowColor("Shadow Color", Color) = (0,0,0,0)
		[Header(Lit Settings)]_LitContribution("Lit Contribution", Range( 0 , 1)) = 1
		_LitColor("Lit Color", Color) = (0,0,0,0)
		[Header(SSS Settings)]_SSSContribution("SSS Contribution", Range( 0 , 1)) = 1
...
/*ASEBEGIN
Version=16103
7;29;1906;1004;838.399;409.5298;1.981599;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;50;-350.5229,1037.315;Float;False;Property;_SSSExponent;SSS Exponent;8;0;Create;True;0;0;False;0;5;15;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;49;-352.5229,963.3146;Float;False;Property;_SSSMultiplier;SSS Multiplier;7;0;Create;True;0;0;False;0;1;0.05;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.NegateNode;7;-267.6052,716.5662;Float;False;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.RangedFloatNode;27;-390.6357,428.3356;Float;False;Property;_ShadowMultiplier;Shadow Multiplier;1;0;Create;True;0;0;False;1;Header(Shadow Settings) ;1;6;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;48;-188.5229,841.3146;Float;False;Property;_SSSContribution;SSS Contribution;5;0;Create;True;0;0;False;1;Header(SSS Settings);1;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;47;-105.3322,452.6096;Float;False;Property;_LitContribution;Lit Contribution;3;0;Create;True;0;0;False;1;Header(Lit Settings);1;1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;34;386.4549,184.6761;Float;False;Property;_ShadowColor;Shadow Color;2;0;Create;True;0;0;False;0;0,0,0,0;0.5808823,0.8098267,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;33;390.6603,365.5269;Float;False;Property;_LitColor;Lit Color;4;0;Create;True;0;0;False;0;0,0,0,0;0.8235294,0.9488843,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;38;514.6902,840.6389;Float;False;Property;_SSSColor;SSS Color;6;0;Create;True;0;0;False;0;0,0,0,0;1,1,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.IntNode;51;1204.63,436.6129;Float;False;Property;_Title;Title;0;0;Create;True;0;0;True;1;MaterialTitle(CLOUD);0;0;0;1;INT;0
...
ASEEND*/
//CHKSM=1E73A3CE12BE13FD1FCC4B649B97B6FC34018406